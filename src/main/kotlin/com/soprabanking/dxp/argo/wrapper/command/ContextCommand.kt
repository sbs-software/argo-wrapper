...
import com.soprabanking.dxp.argo.wrapper.command.ContextCommand.Companion.CONTEXT_GROUP
...
@Command(command = ["context"], group = CONTEXT_GROUP, interactionMode = [INTERACTIVE])
